...
// 'מטפל/ת' and the adjacent role_detail column holds 'עו"ס' (ASCII double
// quote, U+0022) — the UI merely displays them joined with a dash. Both are
// compared trimmed; plain 'מטפל/ת' with any other or empty detail is a
// therapist and is NOT covered.
...
function isHadrachaRole(role, roleDetail) {
  ...
  if (r === HADRACHA_SOCIAL_WORKER_ROLE) {
    return String(roleDetail || '').trim() === HADRACHA_SOCIAL_WORKER_DETAIL;
  }
