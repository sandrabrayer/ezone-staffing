...
// (HADRACHOT_FEED_ROLES in apps-script/Code.gs). The exact strings stored
// in the assignments sheet: guide, social worker (stored 'מטפל/ת'), house
// manager (stored 'מנהל/ת'), coordinator.
const HADRACHA_ROLES = ['מדריך/ה', 'מטפל/ת', 'מנהל/ת', 'רכז/ת'];
