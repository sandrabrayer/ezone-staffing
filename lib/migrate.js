...
// Legacy event row → v3 absence + coverage pair.
//
// Old model: "employee E helped host_house from home_house, possibly
//   replacing covers_employee_id."
// New model: an ABSENCE record (who is missing from where) + a COVERAGE
//   record (who is helping, from where).
//
// Mapping:
...
//   coverage.providingHouse   = ev.homeHouse
...
// workerId='' and a marker note — the FK from coverage → absence stays
// valid, and the cost record (extra_payment attribution) is preserved.
